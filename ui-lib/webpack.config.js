...
var config = {
  ...
  entry: {
    'aurum-ui': [PATHS.entryPoint],
    'aurum-ui.min': [PATHS.entryPoint]
  },
  // The output defines how and where we want the bundles. The special
  // value `[name]` in `filename` tell Webpack to use the name we defined above.
  // We target a UMD and name it aurumUI. When including the bundle in the browser
  // it will be accessible at `window.aurumUI`
  output: {
    path: PATHS.bundles,
    filename: '[name].js',
    libraryTarget: 'umd',
